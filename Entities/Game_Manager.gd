...
var LEVEL_RANK_S = [0, 50000, 60000, 20000, 60000, 60000, 30000, 60000, 60000, 40000, 40000, 160000, 80000, 60000, 60000, 120000, 120000, 300000, 0]
var LEVEL_PUNISHED:Array
var LEVEL_RANK_A = [0, 90000, 120000, 70000, 120000, 180000, 60000, 120000, 150000, 70000, 130000, 240000, 120000, 150000, 120000, 200000, 170000, 360000, 0]
var LEVEL_RANK_B = [0, 180000, 210000, 160000, 180000, 240000, 150000, 180000, 195000, 180000, 300000, 300000, 180000, 210000, 180000, 300000, 220000, 420000, 0]
var LEVEL_SRANK_S = [0, 50000, 60000, 25000, 60000, 60000, 30000, 60000, 60000, 40000, 40000, 160000, 80000, 60000, 60000, 120000, 120000, 320000, 0]

var HELL_RANK_S = [0, 60000, 80000, 40000, 70000, 80000, 40000, 60000, 70000, 50000, 50000, 160000, 80000, 90000, 90000, 150000, 160000, 300000, 0]
var HELL_RANK_A = [0, 120000, 360000, 240000, 210000, 210000, 240000, 180000, 200000, 120000, 210000, 390000, 300000, 190000, 150000, 230000, 230000, 360000, 0]
var HELL_RANK_B = [0, 180000, 480000, 300000, 300000, 270000, 300000, 210000, 300000, 180000, 300000, 420000, 360000, 240000, 210000, 320000, 250000, 420000, 0]
var HELL_SRANK_S = [0, 80000, 100000, 80000, 90000, 100000, 50000, 90000, 70000, 50000, 90000, 160000, 120000, 90000, 90000, 150000, 160000, 320000, 0]
...
func levels_completed():
	...
	for s in LEVEL_TIMES:
		...
		if s != "N/A":
			...
			print(c)
		if not f:
			if HELL_TIMES[LEVEL_TIMES.find(s)] != "N/A":
				c += 1
				print("HELL", c)
	if c >= 18:
		return true
...
func _enter_tree()->void :
	...
	if dir.open("user://") == OK:
		...
		if logfile.open("user://logs/mods.log", File.WRITE) == OK:
			logfile.store_line("-- CruS Mod Base Standalone Build (for May 21 beta build) --\n")
			...
			logfile.close()
	preload("res://MOD_CONTENT/CruS Mod Base/init.gd").new()
	...
	implants = $Implants
	WEAPONS_UNLOCKED = [true, true, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false]
	CURRENT_WEAPONS = [true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false]
...
var MODS = [{"name":"CruS Mod Base"}]
var MOD_DATA = {"CruS Mod Base":{}}
